        ...
        public static void PrintMenu()
        {
            ...
            while (option < 6)//we have 6 differnt options of sactions, so whie the user chose one of them
            {
                switch (mo)
                {
                    ...
                    case MenuOpt.Add://if chose to add
                        ...
                        switch (addO)//checking ehat he chose to add
                        {
                            ...
                            case AddOpt.AddStation://adding a station
                                ...
                                s.StationLocation.Lattitude = Convert.ToInt64(Console.ReadLine());
                                s.StationLocation.Longitude = Convert.ToInt64(Console.ReadLine());
                            ...
                            case AddOpt.AddCustomer://adding a customer
                                ...
                                cus.CustLocation.Lattitude = Convert.ToInt64(Console.ReadLine());
                                cus.CustLocation.Longitude = Convert.ToInt64(Console.ReadLine());
                    ...
                    //            List<Drone> temp = bl.ListDrone().ToList();
                    ...
                    //            List<Station> Stations = bl.ListStation().ToList();
                    ...
                    //            List<Parcel> ListParcel = bl.ListParcel().ToList();
                    ...
                    //            List<Customer> ListCustomer = bl.ListCustomer().ToList();
                    ...
                    //            List<Parcel> ListP = bl.ListParcel().ToList();
                    ...
                    //            List<Station> StationsList = bl.ListStation().ToList();
